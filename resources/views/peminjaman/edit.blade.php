...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Edit Data Peminjam</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <a href="/peminjaman" class="btn btn-primary">Kembali</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif -->
                        <form action="/peminjaman-edit/{{ Request::segment(2) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                                <label for="name" class="form-label">Peminjam</label>
                                <input type="text" name="peminjam" value="{{ $data -> peminjam }}" class="form-control" id="nama">
                            </div>
                            <div class="mb-3">
                                ...
                                <select name="nama" id="nama" class="form-control">
                                    @foreach($alat as $alt)
                                    @if($data->nama == $alt->id)
                                        <option selected value="{{ $alt->id }}"> {{ $alt->nama }} </option>
                                        @else
                            ...
                            <input type="hidden" name="qty_awal" value="{{ $data -> qty }}" class="form-control" id="qty">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="notelepon" value="{{ $data -> notelepon }}" class="form-control" id="nama">
                            </div>
